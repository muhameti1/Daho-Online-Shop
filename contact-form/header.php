  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right" style="margin-right:80px;">
        ...
        <li class="dropdown">
		<i class="fa fa-user dropdown-toggle" aria-hidden="true" data-toggle="dropdown" href="#" style="height: 50px; margin-top:30px;margin-left:8px"></i>
...
<br><br><br>
  <div class="txt-heading" style="text-align:left;color:#d5d5d5;"><a href="../index2.php" style="text-decoration:none;color:#000;margin-left:120px;">Home ></a> Contact Us > <a href="contact-view.php" style="color:#000;text-decoration: none;">Contact Form</a></div>
  <hr>
  <?php }?>
