...
?>
 <div class="container-fluid" style="width:90%;">
  <div class="row">
    <div class="col-sm-3" style="background-color:#f8f8f8;color:#428bca;">
    ...
    <div class="col-sm-7" style="background-color:#e3e3e3;margin-left: 10px;">
      <div id="product-grid">
        <?php
  $query=mysqli_query($conn,"select * from members where mem_id='$ID'")or die(mysqli_error());
$row=mysqli_fetch_array($query);
  ?>          
              ...
              <span style="color: #428bca;text-align: center;margin-left:30px;">First Name:
