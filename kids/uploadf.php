...
<style type="text/css">
	...
	<div class="col-md-6 well" style="margin-top:80px;background-color:#ffffff;border:360px;">
		<h3 class="text-primary" style="text-align:center;">DAHO - Upload Products</h3>
...
<?php } ?>
				...
				<input type="text"  class="form-control" name="name" style="width:50%;" required="" placeholder="eg: shoes,clothes," /><br>
				<label>Type:</label>
				<input type="text"  class="form-control" name="code" style="width:50%;" required="" placeholder="eg: boots,hoodie,jacket" /><br>
				<label>Price:</label>
				<input type="text" class="form-control" name="price" style="width:50%;" required="" placeholder="eg: 200.00,200.60"><br>
				<label>MadeIN:</label>
				<input type="text" class="form-control" name="madein" style="width:50%;" required="" placeholder="eg: USA,China,South Korea"><br>
