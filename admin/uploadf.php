...
<style type="text/css">
	...
	<div class="col-md-6 well" style="margin-top:80px;background-color:#ffffff;border:360px;">
		<h3 class="text-primary" style="text-align:center;">DAHO - Add Products</h3><br>
		...
		<div>
			...
			<label>Product Type:</label>
				...
				<label>Type:</label>
				<input type="text"  class="form-control" name="code" style="width:50%;" required="" placeholder="e.g: blouse, sunglasses" /><br>
				<label>Price:</label>
