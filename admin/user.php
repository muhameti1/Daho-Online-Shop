...
<br><br><br>
<div style="background: #fff;max-width: 100%; margin-top: 35px;"><p style="margin-left: 100px;font-weight: bolder;">Admin ><a href="index.php" style="text-decoration: none;color: #000"> Home ></a> <a href="" style="text-decoration: none;color: #000"> Users</a></p></div>
 <hr>
  ...
  <div class="row">
    ...
    <div class="col-sm-9" style="background-color:#e3e3e3;margin-left:10px;">
      <p>Edit users</p>
          ...
          <tbody>
              <?php
              $result= mysqli_query($conn,"select * from members order by mem_id DESC ") or die (mysqli_error());
