  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right" style="margin-right:80px;">
		...
		<li class="font"><a href="../women/women.php">SHOP</a></li>
...
<div class="txt-heading" style="height:40px;"><span style="margin-left:100px;"><a href="../index2.php" style="color:#000 ;text-decoration:none;">Home ></a> Product > <a href="women.php" style="color:#000;text-decoration:none;">Women ></a> AddToCart</span></div>
<hr>
...
<span class="label label-danger" style="margin-left:300px;font-size:20px;">Your Total Price Is: <span id="total_price"><?php echo  number_format($total_price,2). " Euro "; ?></span></span>
<div class="cart_footer_link" style="margin-top:30px;margin-left:200px;">
<a href="shopping_cart.php?action=empty" class="btn btn-danger btn1" style="border-radius:5px;width:150px;">Clear Cart</a>
<a href="women.php" title="Cart" class="btn btn-primary btn2" style="border-radius:5px;width:180px;">Continue Shopping</a>
<a href="#" class="btn btn-primary btn2" style="border-radius:5px;width:180px;">Go To Payment</a>
</div> 
</div>
    </div>
  </div>
