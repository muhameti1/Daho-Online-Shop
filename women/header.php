  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right" style="margin-right:80px;">
        ...
        <li class="font"><a href="#contact">ABOUT US</a></li>
...
<br><br><br>
  <div class="txt-heading" style="text-align:left;color:#d5d5d5;"><a href="../index2.php" style="text-decoration:none;color:#000;margin-left:120px;">Home ></a> Products > <a href="mens.php" style="color:#000;text-decoration: none;">Profile</a></div>
  <hr>
  <?php }?>
